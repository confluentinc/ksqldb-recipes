Setup your environment in [Confluent Cloud](https://www.confluent.io/confluent-cloud/tryfree/), a fully-managed Apache Kafka® service. Within your environment create a [ksqlDB](https://ksqldb.io/) application.
